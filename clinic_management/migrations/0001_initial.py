# Generated by Django 5.1 on 2024-11-28 16:15
...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(
            name='Diseases',
            fields=[
                ('DiseaseID', models.CharField(editable=False, max_length=30, primary_key=True, serialize=False)),
        ...
        migrations.CreateModel(
            name='Doctor',
            fields=[
                ('DoctorID', models.CharField(editable=False, max_length=30, primary_key=True, serialize=False)),
                ('Name', models.CharField(max_length=100)),
        ...
        migrations.CreateModel(
            name='Medicine',
            fields=[
                ('MedicationID', models.CharField(editable=False, max_length=30, primary_key=True, serialize=False)),
                ('Name', models.CharField(max_length=100)),
        ...
        migrations.CreateModel(
            name='Patient',
            fields=[
                ('PatientID', models.CharField(editable=False, max_length=30, primary_key=True, serialize=False)),
                ('Name', models.CharField(max_length=100)),
                ('Phone', models.CharField(max_length=15)),
                ('Email', models.EmailField(max_length=254)),
                ('Birthdate', models.DateField()),
        ...
        migrations.CreateModel(
            name='Treatment',
            fields=[
                ('TreatmentID', models.CharField(editable=False, max_length=30, primary_key=True, serialize=False)),
        ...
        migrations.CreateModel(
            name='Availability',
            fields=[
                ('AvailabilityID', models.CharField(editable=False, max_length=30, primary_key=True, serialize=False)),
        ...
        migrations.CreateModel(
            name='MedicalRecord',
            fields=[
                ('MedicalRecordID', models.CharField(editable=False, max_length=30, primary_key=True, serialize=False)),
        ...
        migrations.CreateModel(
            name='Dosage',
            fields=[
                ('DosageID', models.CharField(editable=False, max_length=30, primary_key=True, serialize=False)),
        ...
        migrations.CreateModel(
            name='MedicineRecord',
            fields=[
                ('MedicineRecordID', models.CharField(editable=False, max_length=30, primary_key=True, serialize=False)),
        ...
        migrations.CreateModel(
            name='Insurance',
            fields=[
                ('InsuranceID', models.CharField(editable=False, max_length=30, primary_key=True, serialize=False)),
        ...
        migrations.CreateModel(
            name='Appointment',
            fields=[
                ('AppointmentID', models.CharField(editable=False, max_length=30, primary_key=True, serialize=False)),
        ...
        migrations.CreateModel(
            name='Payment',
            fields=[
                ('PaymentID', models.CharField(editable=False, max_length=30, primary_key=True, serialize=False)),
                ('BaseCharge', models.PositiveIntegerField()),
        ...
        migrations.CreateModel(
            name='CoveragePolicy',
            fields=[
                ('PolicyID', models.CharField(editable=False, max_length=30, primary_key=True, serialize=False)),
