...
path('edit_medicine_record/<str:medicine_record_id>/', views.edit_medicine_record, name='edit_medicine_record'),
path('edit_medical_record/<str:medical_record_id>/', views.edit_medical_record, name='edit_medical_record'),
...
path('edit_dosage/<str:dosage_id>/', views.edit_dosage, name='edit_dosage'),
path('edit_medicine/<str:medicine_id>/', views.edit_medicine, name='edit_medicine'),
path('edit_treatment/<str:treatment_id>/', views.edit_treatment, name='edit_treatment'),
path('edit_disease/<str:disease_id>/', views.edit_disease, name='edit_disease'),
